...
def main() -> None:
    ...
    # cpp_attack = embedding_cpp.AttackDataEmbedding(dim)
    ...
    # _assert_close("AttackDataEmbedding", py_attack(attack_data), cpp_attack.forward(attack_data))

    # py_discard = card_embedding.DiscardDataEmbedding(dim)
    # cpp_discard = embedding_cpp.DiscardDataEmbedding(dim)
    ...
    # cpp_amount = embedding_cpp.CardAmountDataEmbedding(cpp_shared, dim)
    ...
    # cpp_ret = embedding_cpp.ReturnToDeckTypeDataEmbedding(cpp_shared, dim)
    ...
    # cpp_player = embedding_cpp.PlayerTargetDataEmbedding(cpp_shared, dim)
