...
struct CardAmountDataEmbeddingImpl : torch::nn::Module, SaveLoadMixin<CardAmountDataEmbeddingImpl> {
    CardAmountDataEmbeddingImpl(std::shared_ptr<SharedEmbeddingHolderImpl> shared_embedding_holder,
