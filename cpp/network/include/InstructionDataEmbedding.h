...
struct InstructionDataEmbeddingImpl : torch::nn::Module, SaveLoadMixin<InstructionDataEmbeddingImpl> {
    InstructionDataEmbeddingImpl(std::shared_ptr<SharedEmbeddingHolderImpl> shared_embedding_holder,
